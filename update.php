...
if(isset($_POST['submit'])){
  try{
    ...
    // 動的に変わる値をプレースホルダーに置き換えたUPDATE文をあらかじめ用意する
    $sql_update = '
      UPDATE products
    ...
    // 商品一覧ページにリダイレクトさせる（同時にmessageパラメーターも渡す）
      ...
      <article class="registration">
        ...
        <form action="update.php?id=<?= $_GET['id'] ?>" method="post" class="registration-form">
          <div>
            ...
            <input type="number" name="stock_quantity" value="<?= $product['stock_quantity'] ?>" min="0" max="100000000">
